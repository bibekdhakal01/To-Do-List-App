...
A simple and intuitive To-Do List Web Application built with HTML, CSS, andJavaScript that helps users keep track of tasks, mark them complete, and remove them when done. 
